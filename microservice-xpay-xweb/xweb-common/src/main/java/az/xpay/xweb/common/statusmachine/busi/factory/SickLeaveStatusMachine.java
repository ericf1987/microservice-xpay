 ...
 */
public class SickLeaveStatusMachine extends AbstractStatusMachine {
    ...
    public static void main(String[] args) {
        SickLeaveStatusMachine ssm = new SickLeaveStatusMachine();
        ssm.testFullApprovalProcess(APPLY, AGREE);
    }
}
